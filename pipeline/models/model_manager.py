...
from .downloader import download_models, Preset_model_website
...
class ModelManager:
    ...
    def load_model(self, file_path, model_names=None, device=None, torch_dtype=None, local_model_path=None):
        ...
        for model_detector in self.model_detector:
            if model_detector.match(file_path, state_dict):
                model_names, models = model_detector.load(
                    ...
                    allowed_model_names=model_names, model_manager=self, local_model_path=local_model_path
                )
                for model_name, model in zip(model_names, models):
                    self.model.append(model)
                    self.model_path.append(file_path)
